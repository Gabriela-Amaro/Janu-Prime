...
class ClienteRegistrationSerializerTest(TestCase):
  ...
  def test_cliente_registration_serializer_invalid_data(self):
    ...
    self.assertEqual(serializer.errors["cpf"][0].title(), "Cliente Com Este Cpf Já Existe.")

    self.assertEqual(serializer.errors["telefone"][0].code, "unique")
    self.assertEqual(serializer.errors["telefone"][0].title(), "Cliente Com Este Telefone Já Existe.")