...
class Estabelecimento(models.Model):
    ...
    logotipo = models.ImageField(upload_to='logotipos/', blank=True) # configurar o upload de imagens depois
    cnpj = models.CharField(max_length=18, unique=True, help_text="Formato: 12.345.678/0001-99")
    horario_funcionamento = models.JSONField(default=dict, blank=True)  # Exemplo: {"segunda": "08:00-18:00", "terça": "08:00-18:00", ...}
